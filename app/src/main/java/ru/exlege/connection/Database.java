...
public class Database extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_AP = "CREATE TABLE administratorPrivileges(adm_key TEXT NOT NULL PRIMARY KEY, adm_deadlock INTEGER NOT NULL DEFAULT 0);";
    ...
    private static final String SQL_CREATE_VT = "CREATE TABLE votos(vot_ele_titulo LONG NOT NULL, vot_can_pid INTEGER NOT NULL, vot_branco INTEGER NOT NULL DEFAULT 0, PRIMARY KEY (vot_ele_titulo,vot_can_pid), FOREIGN KEY (vot_ele_titulo) REFERENCES eleitores(ele_titulo), FOREIGN KEY (vot_can_pid) REFERENCES candidatos (can_pid));";
